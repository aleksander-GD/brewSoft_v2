...
public class MachineController implements IMachineControl {
    ...
    public Map<String, String> startProduction() {
        String returnTxt;
        Map<String, String> rtm = new HashMap();
        if (!msdh.checkMachineStatus(machineObj.getMachineID())) {
            if (this.mconn.getStatus()) {
                ...
                if (newBatch != null) {
                    ...
                    msdh.changeMachineStatus(true, machineObj.getMachineID());
                    try {
            ...
            returnTxt = "The machine is already running. Try a different machine.";
            rtm.put("Error", returnTxt);
        }
        return rtm;
    }
    ...
    public Map<String, String> resetMachine() {
        ...
        if (!msdh.checkMachineStatus(machineObj.getMachineID())) {
            ...
            rtm.put("Error", "The machine is already running. Try a different machine.");
        }
        return rtm;
    }
        ...
        if (this.mconn.getStatus()) {
            if (newBatch != null) {
                ...
                if (res.equals("")) {
                    ...
                    msdh.changeMachineStatus(false, machineObj.getMachineID());
