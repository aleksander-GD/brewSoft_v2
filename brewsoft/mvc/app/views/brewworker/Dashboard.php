<div class="container-fluid">
  <div class="row">
      ...
      <div class="row justify-content-center">
        <div class="barley col-2 col-sm-2 col-lg-1 inventory" id="barley">
          ...
          <div class="progress progress-bar-vertical">
            <div id="barley-statusbar" class="progress-bar bg-success" style="height:50%"></div>
          </div>
        </div>
        <div class="hops col-2 col-sm-2 col-lg-1 inventory" id="hops">
          ...
          <div class="progress progress-bar-vertical">
            <div id="hops-statusbar" class="progress-bar bg-success" style="height: 50%"></div>
          </div>
        </div>
        <div class="malt col-2 col-sm-2 col-lg-1 inventory" id="malt">
          ...
          <div class="progress progress-bar-vertical">
            <div id="malt-statusbar" class="progress-bar bg-success" style="height:50%"></div>
          </div>
        </div>
        <div class="wheat col-2 col-sm-2 col-lg-1 inventory" id="wheat">
          ...
          <div class="progress progress-bar-vertical">
            <div id="wheat-statusbar" class="progress-bar bg-success" style="height:50%"></div>
          </div>
        </div>
        <div class="yeast col-2 col-sm-2 col-lg-1 inventory" id="yeast">
          ...
          <div class="progress progress-bar-vertical">
            <div id="yeast-statusbar" class="progress-bar bg-success" style="height:50%"></div>
          </div>
        </div>
      </div>
    ...
    <div class="maintenance-status col col-md-2 ">
      ...
      <div class="progress progress-bar-vertical">
        <div id="maintenance-statusbar" class="progress-bar bg-danger" style="height: 50%"></div>
      </div>
    </div>
  </div>
</div>
